  ...
  return (
    <main className="min-h-screen bg-black text-white p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="fade-in-slide-up" style={{ animationDelay: '200ms' }}>
        ...
        <div className="fade-in-slide-up" style={{ animationDelay: '300ms' }}>
          <InvestmentCalculator coinId={params.id} currentPrice={details.market_data.current_price.usd} />
        </div>

        <div className="fade-in-slide-up" style={{ animationDelay: '400ms' }}>
